...
* [How to Use](#How-to-Use)
	...
	* [GaussianBlur_RenderBlur](#GaussianBlur_RenderBlur)
		...
		* [Troubleshooting](#Troubleshooting)
		  * [It's Blocky](#It's-Blocky)
		  * [I've got a ton of Errors!](#I've-got-a-ton-of-Errors!)
		  * [Dosen't Do WorldSpace](Dosen't-Do-WorldSpace)
...
1. Example GameObject will create BlurRenderer GameObject.
2. BlurRenderer will take an image(s) of the screen, blur them, and save them as global textures (any shader can use them).
	2a. Example GameObject will re-render the blur every 0.25sec (adjustable)
...
![Imgur](http://i.imgur.com/pdDHWt3.png)
...
The blur effect will seem to jump a bit when the texture(s) are updated.
This is something i will be working on in the next few months.

>**WARNING!**  
In order to accomplish this i might need to render more textures